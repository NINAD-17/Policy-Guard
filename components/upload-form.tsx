...
export function UploadForm({ onUploadSuccess }: UploadFormProps) {
    ...
    return (
        <div className="glass-panel bg-card/45 backdrop-blur-xl border border-white/10 shadow-[0_12px_40px_-10px_rgba(0,0,0,0.5)] rounded-[2rem] p-6 sm:p-8 transition-all duration-300 w-full max-w-full overflow-hidden space-y-6">
